...
*Not to be confused with Dead Weedwood Bush or Infested Weedwood Bush.*

[Aside block] Weedwood Bush
---------------------------
...
Weedwood Bushes ingame

**Weedwood Bushes** are plant blocks that generate in patches in Swamplands and Coarse Islands biomes.
...
Weedwood Bushes take on different foliage colors depending on what biome they are in. The foliage color is:
...
Weedwood Bushes can be Infested by right-clicking them with a Pheromone Thorax. Infested Weedwood Bushes are then used to grow Silk Grubs. If right-clicked with a Thorax Clutch, they will die and spawn an Infestation. They can also be infested with a Grub Hub and Pheromone Extract.

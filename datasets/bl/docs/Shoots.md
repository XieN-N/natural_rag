...
shoots  
items\_plant\_drop/24  
items\_crushed/3

Shoots ingame

**Shoots** are plants that generate in Patchy Islands biomes. They can also be sprouted from Swamp Grass using Ground Dried Swamp Reed, and can be grown from Root Pods.
...
| --- | --- | --- |
| Ground Shoots | Shoots (item) + Pestle (1 use) |  |

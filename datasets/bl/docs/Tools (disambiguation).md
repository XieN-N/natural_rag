...
"Tools" refer to several different basic sets of tools (encompassing Swords, Pickaxes, Axes, and Shovels) made with common materials. This disambiguation page lists all toolsets added in the mod.

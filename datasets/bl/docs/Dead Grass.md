...
### Generation
Dead Grass generates in large quantities on the surface of Swamplands biomes, and can be obtained by breaking Swamp Grass with a Sickle.
...
Dead Grass drops Swamp Dirt when broken. The block itself must be broken with a Silk Touch tool to be collected.

...
The following is a list of all **Items** that are added by the Betweenlands mod.

For their IDs, see Item IDs. For blocks, see Blocks.
...
* Pheromone Thorax: Used to make Pheromone Extract and harvest silk from Weedwood Bushes.
...
* Silk Grub Cocoon: Used to make Silk Threads.
* Silk Thread: Used to make Samite, fishing rods, bundles, and other useful items.
...
* Baked Olm Egg Cluster: Obtained by cooking Olm Egg Clusters.
* Ball of Sap: An edible item obtained from trees that replenishes the decay bar.
* Barnacle Flesh: Collected from Barnacle Clusters.
* Black Hat Mushroom: An edible, although not very sustaining, mushroom.
...
* Cooked Anadia Meat: Obtained by cooking Raw Anadia Meat.
* Cooked Barnacle Flesh: Obtained by cooking Barnacle Flesh.
* Cooked Mire Snail Egg: Obtained by cooking Mire Snail Eggs.
* Crab Claw: A drop from Silt Crabs and Bubbler Crabs.
* Crabstick: Crafted with Crab Claws.
* Flathead Mushroom: An edible, although not very sustaining, mushroom.
...
* Olm Egg Cluster: The product of feeding Snot to Olms.
* Olmlette: Obtained by cooking a Mixture of Olm Egg Clusters and various mushrooms.
* Pearled Pear: Crafted with a White Pear and Rocksnot Pearls.
* Pink Marshmallow: Increases jump height when eaten.
* Puffshroom Tendril: Obtained by shearing Puffshrooms.
* Raw Anadia Meat: Obtained by trimming Anadias.
...
* Rocksnot Pearl: Obtained when a Rocksnot swallows mobs, grants experience.
...
* Silk Grub: Obtained by harvesting Silk Grub Infested Weedwood Bushes.
* Sludge Jello: Obtained by cooking Sludge Balls.
* Smoked Anadia Meat: Obtained by smoking Raw Anadia Meat.
* Smoked Barnacle Flesh: Obtained by smoking Barnacle Flesh.
* Smoked Crabstick: Obtained by smoking Crabstick.
* Smoked Crab Claw: Obtained by smoking Crab Claw.
* Smoked Frog's Leg: Obtained by smoking Raw Frog's Leg.
* Smoked Puffshroom Tendril: Obtained by smoking Puffshroom Tendril.
* Smoked Snail Flesh: Obtained by smoking Raw Snail Flesh.
* Spirit Fruit: Regenerative fruit obtained from Spirit Tree Leaves.
* Sushi: Crafted with Swamp Kelp, Raw Anadia Meat, and Ground Lichen.
...
* Amphibious Armor: Special armor that can be upgraded to mimic the powers of aquatic life.
...
* Fish Bait: A special ammunition for Simple Slingshots used to attract Anadia mobs.
* Fishing Spear: A spear used to hunt the aquatic life as well as land life.
...
* Staff of the Mist Walker: A rare staff capable of creating a mist bridge out of thin air.
* Staff of the Shadow Walker: A rare staff capable of turning blocks into shadows to create a passage.
...
* Weedwood Fishing Rod: A tool used to catch Anadia mobs.
...
* Aspectrus Fruit: Fruit from a unique crop that is infused with an aspect.
* Bottled Fog: Vials of fog used in the Censer for growing certain plants.
* Bottled Shallowbreath: Vials of Shallowbreath gas used to fuel the Draeton.
* Dentrothyst Vials: Containers for Infusions, Aspects, and other substances.
* Ground Items: Various materials ground in the Mortar, used in infusions.
* Herblore Book: A book that details Aspect effects and recipes based on observations.
...
* Pestle: Can be combined with a Mortar to grind certain items.
* Plant Items: Various parts of different plants that can be ground.
* Sickle: A tool capable of harvesting plant items from various Betweenlands plants.

**Other Items**
---------------

* Amate Map: A map that records the various biomes and structures of the Betweenlands environment.
* Amate Name Tag: The Betweenlands equivalent of the Nametag.
* Anadia: An Anadia caught with the Weedwood Fishing Rod.
* Angry Pebble: Special pebbles that can be animated into sentient explosives.
* Aspectrus Seeds: Used to grow Aspectrus Plants.
* Barnacle Larvae: Can be placed and grown in water.
* Bubbler Crab: A Bubbler Crab caught using the Crab Pot.
* Cave Fish: A Cave Fish caught using the Net.
...
* Dragonfly: A Dragonfly caught with the Net.
* Firefly: A Firefly caught with the Net.
* Freshwater Urchin: A Freshwater Urchin caught using the Net.
* Fumigant: Used to remove the stench of Rot.
* Gallery Frame: Used to display fan art made for the Betweenlands.
* Gecko: A Gecko caught with the Net.
...
* Jellyfish: A Jellyfish caught using the Net.
...
* Mire Snail: A Mire Snail caught using the Net.
...
* Olm: An Olm caught using the Net.
* Pyrad Flame: Weaponized fire derived from the Pyrads.
* Rocksnot Pod: A friendly Rocksnot that will swallow everything but the player and bosses.
...
* Silt Crab: A Silt Crab caught using the Crab Pot.
...
* Chiromaw: A hatchling-raised Chiromaw caught with the Net.
...
* Armor of Legends: Powerful armor obtained after killing the Prime Wight.
* Guide Book: An ingame guide to the content of the mod, currently unfinished.
* Kraken Calamari: Obtained by cooking Kraken Tentacles.
* Kraken Tentacle: Obtained from the Swamp Kraken.
* Snapper Root: A drop from Snappers.
* Stalker Eye: A drop from Stalkers.
* Sword of Legends: A powerful sword obtained after killing the Prime Wight.

...
* Anadia: A fish species coming in various shapes and sizes, fished for its food and treasures.
* Cave Fish: A small fish that swims in groups in the dark waters of the Lake Caverns.
...
* Greebling Coracle: A peaceful gremlin that hums while paddling across the waters.
* Mire Snail: A peaceful snail that can be farmed, unlike its ornery cousins.
* Olm: A small passive creature inhabiting the dark waters of the Lake Caverns.
...
* Freshwater Urchin: A small avoidant urchin that shoots spikes when in danger.
* Greebling Rider: A mischievous gremlin riding a Chiromaw high in the sky.
* Jellyfish: A multicolored, glowing invertebrate found in surface waters that will sting to defend itself.
* Lurker: A large, strong reptilian creature that attacks when provoked.
* Pyrad: A corrupted nature spirit that shoots flames at anyone who provokes it or its tree.
...
* Emberling: A fiery salamander-like creature that can be tamed.
* Harlequin Toad: A big, slimy amphibian that can be tamed and ridden.
* Tarminion: A craftable little tar-based creature that will attack hostile mobs.

**Chief Mobs**
--------------

* Barrishee: A terrifying mechanical abomination that disguises as a door in the Sludgeon.
* Chiromaw Matriarch: A great winged beast that protects its Nest atop the Raised Isles.

**Bosses**
----------

* Dreadful Peat Mummy: An incarnation of pure terror that can be summoned out of the ground.
* Primordial Malevolence: A sphere of malignant energy found atop the Wight Fortress.
* Sludge Menace: A massive tentacle of decay that bursts from the pit of the Sludgeon.
* Spirit Tree: A sentient, elderly tree whose power is determined by the wisps surrounding it.
...
* Draeton: An aircraft used to soar the skies of the Betweenlands.
* Gallery Frame: Used to display fan art made for the Betweenlands.
* Glowing Goop: A light source that can be thrown.
* Greebling Corpse: The lootable corpse of a Greebling picked off by a Chiromaw Matriarch.
* Lurker Skin Raft: An emergency raft made from Lurker Skin that can be used as a shield.
* Mire Snail Egg: The product of breeding Mire Snails.
* Moving Wall: A wall that moves back and forth in the bottom level of the Sludgeon labyrinths.
...
* Sludge Jet Turret: A rotating turret in the Sludgeon labyrinth that shoots sludge at the player.
...
* Splodeshroom: A Noxious mushroom that bursts into blinding spores when approached.
* Tunnel Entrances: Holes that appear in the ground during certain events and spawn mobs.
* Weedwood Rowboat: A vehicle used to swim the waters of the Betweenlands.
* Worm Hole: A hole that periodically appears in the Sludgeon walls, spawning Small Sludge Worms.

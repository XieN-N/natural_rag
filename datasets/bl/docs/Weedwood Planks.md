...
Weedwood Planks ingame

**Weedwood Planks** are craftable blocks, useful in both building and crafting.
...
Weedwood Planks can be used as fuel for the Sulfur Furnace or Dual Sulfur Furnace, smelting 1.5 items per plank block.
...
| Weedwood Sign | **Weedwood Planks** (6) + Weedwood Stick |  |
| Weedwood Walkway (2) | **Weedwood Planks** (3) + Weedwood Stick (2) |  |
| Blank Amate Paper Lantern | **Weedwood Planks** (3) + Weedwood Plank Slab (3) + Any Amate Paper Pane (2) + Firefly (item) |  |
| Silt Glass Lantern | **Weedwood Planks** (3) + Weedwood Plank Slab (3) + Silt Glass Pane (2) + Firefly (item) |  |
...
| Moss Bed | **Weedwood Planks** (3) + Moss or Moss (item) or Cave Moss or Cave Moss (item) (3) |  |
...
| Weedwood Rowboat Lantern Upgrade | **Weedwood Planks** (3) + Weedwood Plank Slab (3) + Reed Rope (2) + Firefly (item) |  |

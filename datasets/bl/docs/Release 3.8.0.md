...
**Release 3.8.0** was a major update to the Betweenlands for Minecraft 1.12.2 that was released on October 28, 2021. It was known as the **Net Fish & Chill** update as it added a complex Anadia fishing system, Crab Pots and Filters, the Smoking Rack and Fish Trimming Table, and several new aquatic mobs, alongside a variety of other additions, changes, and bug fixes.
...
* Added the Fishing Tackle Box and Reed Mat to sit back and relax on
* Added the Fish Trimming Table and Smoking Rack, for all your seafood needs
* Added the Bubbler Crab, Greebling Coracle, Cave Fish, and Olms
...
* Added Rocksnot Pearls and Pearled Pears for XP on the go
* Added Freshwater Urchins and Urchin Spikes
* Added Barnacles, a new underwater food source
* Added Smoked Foods (Anadia Meat, Barnacle Flesh, Crab Claw, Crabstick, Frog's Leg, Puffshroom Tendril, and Snail Flesh), a more nourishing way to prepare raw foods
* Added Underwater Ruins along with Mud Pots of Chance, which generate in Deep Waters and Patchy Islands biomes
* Added Betweenstone Pebble piles and Smoldering Peat, which now generate in the world
...
* Added Olm Egg Clusters and Olmlettes
* Added a new Music track by Rovycre
...
* Contact with Stagnant Water or having rotten Anadia in your inventory will now cause you to smell really, really bad; Wights, Lurkers, and Greebling Riders hate this smell, so be careful
...
* The Mushroom Master Advancement has been updated to require Edge Shrooms and Rotbulbs
...
* Tamed Lightning Chiromaws are now immune to being shocked normally

### Mob Changes

* Angler Meat has been removed, use Anadia for your Sushi instead
...
* Shamblers now drop 0-1 Shambler Tongues instead of 1-4
...
* Tame Emberlings now heal twice as fast as before (now 1 HP every 30s) while sleeping on a Block of Octine
...
* Betweenlands Monster Spawners now use glass sounds instead of stone

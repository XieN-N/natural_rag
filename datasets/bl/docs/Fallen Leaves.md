...
fallen\_leaves  
items\_plant\_drop/0  
items\_crushed/0

Fallen Leaves ingame

**Fallen Leaves** are thin plant-like blocks that generate underneath trees in Swamplands biomes. They can also be stacked in layers up to 4 similarly to snow. When tree leaves decay, they can create Fallen Leaves on the ground below.

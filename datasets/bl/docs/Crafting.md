...
The following is a list of all recipes that utilize a crafting square, such as the player's personal inventory square or a Weedwood Crafting Table, sorted into categories in alphabetical order.

Contents
--------

* 1 Natural Blocks
* 2 Manufactured Blocks
  + 2.1 Slabs
  + 2.2 Stairs
  + 2.3 Slopes
  + 2.4 Fences
...
| Result | Ingredients | Recipe |
| --- | --- | --- |
| Switches Amate Paper Pane variant | Amate Paper Pane |  |
| Aqua Middle Gem Block | Aqua Middle Gem (9) |  |
| Betweenstone Bricks (4) | Betweenstone (4) |  |
| Betweenstone Pillar (2) | Smooth Betweenstone (2) |  |
| Betweenstone Tiles (4) | Smooth Betweenstone (4) |  |
| Block of Compost | Compost (9) |  |
| Block of Octine | Octine Ingot (9) |  |
| Block of Scabyst | Scabyst (9) |  |
| Block of Sulfur | Sulfur (9) |  |
| Block of Syrmorite | Syrmorite Ingot (9) |  |
| Block of Valonite | Valonite Shard (9) |  |
| Corresponding Carved Mud Bricks (4) | Mud Bricks or Sludgy Mud Bricks (6) + Mud Brick (3) |  |
| Switches corresponding Carved Mud Bricks variant | Carved Mud Bricks or Sludgy Carved Mud Bricks or Carved Mud Bricks Edge or Sludgy Carved Mud Bricks Edge |  |
...
| Switches Chiseled Scabyst variant | Chiseled Scabyst |  |
| Connected Amate Paper Pane | Weedwood Stick (4) + Amate Paper |  |
| Cragrock Bricks (4) | Cragrock (4) |  |
| Cragrock Pillar (2) | Smooth Cragrock (2) |  |
| Cragrock Tiles (4) | Smooth Cragrock (4) |  |
| Crimson Middle Gem Block | Crimson Middle Gem (9) |  |
| Deep Water Coral Block (4) | Deep Water Coral (item) (4) |  |
| Giant Root Planks (4) | Giant Root |  |
| Green Middle Gem Block | Green Middle Gem (9) |  |
| Green Polished Dentrothyst Pane (16) | Green Polished Dentrothyst (6) |  |
| Hearthgrove Planks (4) | Any Hearthgrove Log or Tarred Hearthgrove Log |  |
| Limestone Bricks (4) | Limestone (4) |  |
| Limestone Pillar (2) | Polished Limestone (2) |  |
| Limestone Tiles (4) | Polished Limestone (4) |  |
| Mire Coral Block (4) | Mire Coral (item) (4) |  |
| Mossy Betweenstone Bricks | Betweenstone Bricks + Moss or Moss (item) or Cave Moss or Cave Moss (item) |  |
| Mossy Betweenstone Tiles | Betweenstone Tiles + Moss or Moss (item) or Cave Moss or Cave Moss (item) |  |
| Mossy Limestone Bricks | Limestone Bricks + Moss or Moss (item) or Cave Moss or Cave Moss (item) |  |
| Mossy Smooth Betweenstone | Smooth Betweenstone + Moss or Moss (item) or Cave Moss or Cave Moss (item) |  |
| Mud Bricks | Mud Brick (4) |  |
| Mud Brick Shingles (2) | Mud Brick (9) |  |
| Mud Tiles (4) | Mud Bricks (4) |  |
| Nibbletwig Planks (4) | Any Nibbletwig Log |  |

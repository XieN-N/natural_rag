...
* 1 Obtaining
  + 1.1 Aspect Combinations & Distilling
* 2 Properties
  + 2.1 Effects
  + 2.2 Consuming Infusions
  + 2.3 Throwing Infusions
* 3 List of Infusions
  + 3.1 Elixirs
  + 3.2 Brews
  + 3.3 Draughts
...
| Brews | | | | |
| --- | --- | --- | --- | --- |
| **Brew** | **Aspect Combination** | **Effect** | **Duration Range** | **Herblore Book Description** |
| **Hunter's Sense Brew** | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Firnalaz (Fire) | Provides the ability to see "scent trails" of mobs. These are trails of bubble particles that repeatedly trace the path that mobs have walked. | 2:30 - 10:50 | The Hunter’s Sense Brew enhances the senses, allowing one to see and smell the scent trails of creatures in order to track them down. A combination of Freiwynn, Dayuniis, Ordaniis, and Firnalaz aspects is required to make this brew. The more Freiwynn is used, the stronger are the brew’s effects. The more Dayuniis is used, the longer the brew lasts. Adding Byariis will corrupt the nature of the brew, turning it into the Drunkard’s Brew, which causes one to experience heavy nausea. |
| **Masking Brew** | Dayuniis (Mind) + Armaniis (Desire) + Byariis (Corruption) | Makes other entities unable to see the affected, up to a few blocks away. Note that once they notice you they will be able to see you from the normal distance again. | 2:00 - 12:50 | The Masking Brew masks natural odors like a perfume, making it harder for one to be detected by predators. A combination of Dayuniis, Armaniis, and Byariis aspects is required to make this brew. The more Armaniis is used, the stronger are the brew’s effects. The more Dayuniis is used, the longer the brew lasts. Leaving out Byariis will reveal the true nature of the brew, turning it into the Stenching Brew, which makes it easier for one to be detected by predators. |
| **Swiftarm Brew** | Azuwynn (Muscle) + Dayuniis (Mind) + Yunugaz (Wind) + Ordaniis (Enhance) | Makes the player's arm able to automatically swing when the button is held. This allows for easier sword striking, increased mining speed, and increased bow drawing speed. | 2:00 - 9:30 | The Swiftarm Brew enables arm muscles to work to their fullest, increasing one's arm swinging speed and thus allowing them to mine faster, pull back bows more rapidly, and strike foes more easily. A combination of Azuwynn, Dayuniis, Yunugaz, and Ordaniis aspects is required to make this brew. The more Azuwynn is used, the stronger are the brew’s effects. The more Ordaniis is used, the longer the brew lasts. Adding Byariis will corrupt the nature of the brew, turning it into the Slugarm Brew, which decreases one's arm swinging speed. |
| **Brew of the Cat's Eye** | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Geoliirgaz (Void) | Provides the vanilla Night Vision effect, allowing the affected to see more easily in darkness. | 2:00 - 8:40 | The Brew of the Cat's Eye makes the eyes extremely sensitive to light, allowing one to see very well in the dark. A combination of Freiwynn, Dayuniis, Ordaniis, and Geoliirgaz aspects is required to make this brew. The more Freiwynn is used, the stronger are the brew's effects. The more Dayuniis is used, the longer the brew lasts. Adding Byariis will corrupt the nature of the brew, turning it into the Blindman's Brew, which causes one to be blinded. |
| **Drunkard's Brew** | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Firnalaz (Fire) + Byariis (Corruption) | Inflicts the vanilla Nausea effect, causing the screen to wobble. | 0:20 - 1:10 | The Drunkard’s Brew is highly intoxicating, causing one to experience a heavy bout of nausea. A combination of Freiwynn, Dayuniis, Ordaniis, Firnalaz, and Byariis aspects is required to make this brew. The more Freiwynn is used, the stronger are the brew’s effects. The more Dayuniis is used, the longer the brew lasts. Leaving out Byariis will reveal the true nature of the brew, turning it into the Hunter’s Sense Brew, which allows one to detect the scent trails of creatures. |
| **Stenching Brew** | Dayuniis (Mind) + Armaniis (Desire) | Increases the range that mobs can spot the affected by 8 blocks. | 0:30 - 4:40 | The Stenching Brew has a very potent odor that is desired by monsters, making it easier for one to be detected by predators. A combination of Dayuniis and Armaniis aspects is required to make this brew. The more Armaniis is used, the stronger are the brew’s effects. The more Dayuniis is used, the longer the brew lasts. Adding Byariis will corrupt the nature of the brew, turning it into the Masking Brew, which makes it harder for one to be detected by predators. |
| **Slugarm Brew** | Azuwynn (Muscle) + Dayuniis (Mind) + Yunugaz (Wind) + Ordaniis (Enhance) + Byariis (Corruption) | Decreases the player's arm swing speed. This causes more difficult sword striking and decreased mining speed. It also prevents shields from blocking attacks. | 0:10 - 1:00 | The Slugarm Brew makes the arms feel numb, decreasing one's arm swinging speed and thus causing them to mine slower and strike foes less easily. A combination of Azuwynn, Dayuniis, Yunugaz, Ordaniis, and Byariis aspects is required to make this brew. The more Azuwynn is used, the stronger are the brew’s effects. The more Ordaniis is used, the longer the brew lasts. Leaving out Byariis will reveal the true nature of the brew, turning it into the Swiftarm Brew, which increases one's arm swinging speed. |
| **Blindman's Brew** | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Geoliirgaz (Void) + Byariis (Corruption) | Inflicts the vanilla Blindness effect, reducing vision to a few blocks in each direction and negating the ability to sprint. | 0:08 - 0:18 | The Blindman’s Brew severely limits the functions of the eye, causing one to only be able to see a small distance in front of them and be unable to sprint. A combination of Freiwynn, Dayuniis, Ordaniis, Geoliirgaz, and Byariis aspects is required to make this brew. The more Freiwynn is used, the stronger are the brew's effects. The more Dayuniis is used, the longer the brew lasts. Leaving out Byariis will reveal the true nature of the brew, turning it into the Brew of the Cat’s Eye, which allows one to see better in the dark. |

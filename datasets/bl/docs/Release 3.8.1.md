...
**Release 3.8.1** was a small update to the Betweenlands for Minecraft 1.12.2 that was released on November 28, 2021. It tweaked some Fishing-related features, improved subtitles, and made additional changes and bug fixes.
...
* Pots of Chance broken underwater will now spawn a Silt or Bubbler Crab instead of a Termite
...
* Fixed the Biopathic Triggerstone crashing the game when a removed upgrade is selected

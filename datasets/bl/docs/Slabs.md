...
**Slabs** in the Betweenlands act functionally the same as vanilla slabs.
...
This is the list of Slabs available, their IDs, and any additional sources they may have to being crafted:

| Slabs | | |
| --- | --- | --- |
| **Slab** | **ID** | **Other Sources** |
| Betweenstone Slab | betweenstone\_slab | N/A |
| Betweenstone Brick Slab | betweenstone \_brick\_slab | Marsh Ruins, Shrines, Wight Fortress |
| Compacted Mud Slab | compacted\_mud\_slab | Sludgeon |
| Cracked Betweenstone Brick Slab | cracked\_betweenstone \_brick\_slab | N/A |
| Cragrock Slab | cragrock\_slab | N/A |
| Cragrock Brick Slab | cragrock\_brick\_slab | Idol Head Statues, Cragrock Towers |
| Giant Root Plank Slab | giant\_root\_plank\_slab | N/A |
| Hearthgrove Plank Slab | hearthgrove\_plank\_slab | N/A |
| Limestone Slab | limestone\_slab | N/A |
| Limestone Brick Slab | limestone\_brick\_slab | Wight Fortress (Secret room) |
| Mossy Betweenstone Brick Slab | mossy\_betweenstone \_brick\_slab | N/A |
| Mossy Smooth Betweenstone Slab | mossy\_smooth \_betweenstone\_slab | N/A |
| Mud Brick Shingle Slab | mud\_brick\_shingle\_slab | N/A |
| Mud Brick Slab | mud\_brick\_slab | Sludge Plains Ruins, Sludgeon |
| Nibbletwig Plank Slab | nibbletwig\_plank\_slab | N/A |
| Pitstone Slab | pitstone\_slab | N/A |
| Pitstone Brick Slab | pitstone\_brick\_slab | Sludgeon (Sludgeon Tower), Underground Ruins |
| Polished Limestone Slab | polished \_limestone\_slab | N/A |
| Rotten Plank Slab | rotten\_plank\_slab | Sludgeon (Sludgeon Tower) |
| Rubber Tree Plank Slab | rubber\_tree \_plank\_slab | N/A |
| Scabyst Brick Slab | scabyst\_brick\_slab | N/A |
| Sludgy Mud Brick Slab 1 | mud\_brick\_slab\_decay\_1 | Sludgeon |
| Sludgy Mud Brick Slab 2 | mud\_brick\_slab\_decay\_2 | Sludgeon |
| Sludgy Mud Brick Slab 3 | mud\_brick\_slab\_decay\_3 | Sludgeon |
| Sludgy Mud Brick Slab 4 | mud\_brick\_slab\_decay\_4 | N/A |
| Smooth Betweenstone Slab | smooth \_betweenstone\_slab | N/A |
| Smooth Cragrock Slab | smooth\_cragrock\_slab | Idol Head Statues, Cragrock Towers |
| Smooth Pitstone Slab | smooth\_pitstone\_slab | Sludgeon (Sludgeon Tower) |
| Solid Tar Slab | tar\_solid\_slab | N/A |
| Temple Brick Slab | temple\_brick\_slab | N/A |
| Thatch Slab | thatch\_slab | N/A |
| Weedwood Plank Slab | weedwood\_plank\_slab | Marsh Ruins |
...
Wooden Slabs can be used as fuel for the Sulfur Furnace or Dual Sulfur Furnace, smelting 1.5 items per slab block.
...
* Rotten Plank Slabs that generate on the Sludgeon Tower may be rigged as falling blocks, meaning they have a chance to fall if a player walks on or underneath them. A falling block can be indicated by the particles falling from it. The block will become unprotected after it falls.

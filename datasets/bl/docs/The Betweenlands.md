...
The Betweenlands is so foul that Players will decay simply by living in it. The dimension has no daylight cycle of its own, although it experiences some effects from the Overworld's daylight cycle through the periodic Rift event. Additionally, several blocks and items from the Overworld are nullified:
...
Players must use Moss Beds in place of normal Beds to set their spawn point in the Betweenlands. However, since there is no proper daylight cycle, players cannot sleep in Moss Beds to skip any "night", not even through the Rift event.
...
SwampAmbience: https://the-betweenlands.fandom.com/wiki/File:SwampAmbience.ogg
...
* Release 3.3.1: Added effects from the Overworld's daylight cycle through the Rift event.

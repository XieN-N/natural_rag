...
Climbing Rope ingame

**Climbing Rope** is a craftable utility block that serves as a method of climbing in the Betweenlands. In addition to being crafted, it can also be found as part of Marsh Ruins.
...
Climbing Rope can be placed anywhere on a solid block that has no other block directly under it, and will always be placed on the underside of the block. It can then be placed downward and can be climbed, in a similar manner to a vanilla or Weedwood Ladder.

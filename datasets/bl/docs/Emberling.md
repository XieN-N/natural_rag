...
There is not much in the way of just killing the thing, however taming it would be a lot more useful. Even if you lack a shield and it burns you, you can easily just jump into a nearby body of water and it should go down pretty quickly, however do note that Emberlings are very fast in water as well.
...
| --- | --- | --- | --- | --- |
| https://the-betweenlands.fandom.com/wiki/File:EmberlingDeath.ogg | Emberling dies | Hostile Neutral if tamed | Plays when an Emberling dies. | emberling\_death |
| https://the-betweenlands.fandom.com/wiki/File:EmberlingFlames.ogg | Emberling shoots flames | Hostile | Plays when an Emberling attacks with flames. | emberling\_flames |
| https://the-betweenlands.fandom.com/wiki/File:EmberlingHurt1.ogg https://the-betweenlands.fandom.com/wiki/File:EmberlingHurt2.ogg | Emberling hurts | Hostile Neutral if tamed | Plays when an Emberling takes damaged. | emberling\_hurt |
| https://the-betweenlands.fandom.com/wiki/File:EmberlingLiving1.ogg https://the-betweenlands.fandom.com/wiki/File:EmberlingLiving2.ogg https://the-betweenlands.fandom.com/wiki/File:EmberlingLiving3.ogg https://the-betweenlands.fandom.com/wiki/File:EmberlingLiving4.ogg https://the-betweenlands.fandom.com/wiki/File:EmberlingLiving5.ogg | Emberling clicks | Hostile Neutral if tamed | Plays randomly while an Emberling is alive. | emberling\_living |

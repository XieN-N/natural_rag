...
Anywhere between the surface and Lake Cavern layers

### Water Color

#131844 (fades in from the surface down)
...
* Betweenstone, extremely commonly
* Swamp Dirt, in patches from Y=95 to Y=45
* Stalactite, in formations on the floor or ceiling
* Moss, in patches
* Lichen, in patches
* Cave Moss, in clusters hanging from the ceiling
* Thorns, in clusters hanging from the ceiling
* Limestone, in large, relatively uncommon seams from Y=95 to Y=45
* Sulfur Ore, in common veins from Y=100 to Y=45
* Slimy Bone Ore, in uncommon veins from Y=100 to Y=45
* Octine Ore, in relatively common veins from Y=70 to Y=45
* Syrmorite Ore, in uncommon veins from Y=100 to Y=85
* Pot of Chance, in very uncommon, large clusters

  Simulacrums, rarely in the various levels.

...
Dentrothyst Vials ingame

Filled Dentrothyst Vials

**Dentrothyst Vials** are craftable items used for carrying Infusions and Aspect Vials. There are two varieties - Green and Orange.
...
| Result | Ingredients | Recipe |
| --- | --- | --- |
| Alembic | Green Dentrothyst Vial + Green Dentrothyst + Cragrock (2) + Octine Ingot (2) |  |
| Repeller | Green Dentrothyst Vial + Cragrock + Weedwood Stick (2) |  |

History
---------

* Release 3.4.0: Crafting recipe changed.
* Release 3.3.1: Random position can now be toggled with a shift right-click.
* Release 3.3.0: Reduced placed vial size and gave it a random offset.
* Alpha 3.0.0: Reintroduced.
* Beta 2.0.0: Temporarily removed.
* Beta 1.0.2: Can now be placed on the ground.

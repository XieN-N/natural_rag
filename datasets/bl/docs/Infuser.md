...
* 2 Properties
  + 2.1 Infusing
  + 2.2 Infusion Aspect Combinations
    - 2.2.1 Elixirs
    - 2.2.2 Brews
    - 2.2.3 Draughts
* 3 Sounds
...
#### Elixirs
| Elixir Aspect Combinations | |
| --- | --- |
| **Elixir** | **Aspect Combination** |
| Elixir of Decay | Yeowynn (Health) + Ordaniis (Enhance) + Dayuniis (Mind) + Byariis (Corruption) |
| Elixir of Draining | Yeowynn (Health) + Ordaniis (Enhance) + Byariis (Corruption) |
| Elixir of Feasting | Yeowynn (Health) + Ordaniis (Enhance) + Celawynn (Stomach) |
| Elixir of Healing | Yeowynn (Health) + Ordaniis (Enhance) |
| Elixir of Ripening | Yeowynn (Health) + Ordaniis (Enhance) + Dayuniis (Mind) |
| Elixir of Starvation | Yeowynn (Health) + Ordaniis (Enhance) + Celawynn (Stomach) + Byariis (Corruption) |
| Elixir of Strength | Azuwynn (Muscle) + Ordaniis (Enhance) |
| Elixir of Weakness | Azuwynn (Muscle) + Ordaniis (Enhance) + Byariis (Corruption) |
| Lumbering Elixir | Azuwynn (Muscle) + Ordaniis (Enhance) + Yunugaz (Wind) + Byariis (Corruption) |
| Nimblefeet Elixir | Azuwynn (Muscle) + Ordaniis (Enhance) + Yunugaz (Wind) |
| Poisonsting Elixir | Azuwynn (Muscle) + Yeowynn (Health) + Celawynn (Stomach) + Byariis (Corruption) |
| Toughskin Elixir | Azuwynn (Muscle) + Yeowynn (Health) + Celawynn (Stomach) |

#### Brews
| Brew Aspect Combinations | |
| --- | --- |
| **Brew** | **Aspect Combination** |
| Blindman's Brew | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Geoliirgaz (Void) + Byariis (Corruption) |
| Brew of the Cat's Eye | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Geoliirgaz (Void) |
| Drunkard's Brew | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Firnalaz (Fire) + Byariis (Corruption) |
| Hunter's Sense Brew | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Firnalaz (Fire) |
| Masking Brew | Dayuniis (Mind) + Armaniis (Desire) + Byariis (Corruption) |
| Slugarm Brew | Azuwynn (Muscle) + Dayuniis (Mind) + Yunugaz (Wind) + Ordaniis (Enhance) + Byariis (Corruption) |
| Stenching Brew | Dayuniis (Mind) + Armaniis (Desire) |
| Swiftarm Brew | Azuwynn (Muscle) + Dayuniis (Mind) + Yunugaz (Wind) + Ordaniis (Enhance) |

#### Draughts
| Draught Aspect Combinations | |
| --- | --- |
| **Draught** | **Aspect Combination** |
| Basilisk Draught | Azuwynn (Muscle) + Fergalaz (Earth) + Dayuniis (Mind) + Yihinren (Form) + Yunugaz (Wind) + Byariis (Corruption) |
| Draught of Sagittarius | Freiwynn (Vision) + Dayuniis (Mind) + Byariis (Corruption) + Ordaniis (Enhance) + Armaniis (Desire) |
| Draught of the Fogged Mind | Dayuniis (Mind) + Freiwynn (Vision) + Geoliirgaz (Void) + Ordaniis (Enhance) + Yunugaz (Wind) + Byariis (Corruption) |
| Draught of the Unclouded | Dayuniis (Mind) + Freiwynn (Vision) + Geoliirgaz (Void) + Ordaniis (Enhance) + Yunugaz (Wind) |
| Heavyweight Draught | Azuwynn (Muscle) + Byrginaz (Water) + Yunugaz (Wind) + Yihinren (Form) + Geoliirgaz (Void) + Byariis (Corruption) |
| Lightweight Draught | Azuwynn (Muscle) + Byrginaz (Water) + Yunugaz (Wind) + Yihinren (Form) + Geoliirgaz (Void) |
| Spiderbreed Draught | Azuwynn (Muscle) + Fergalaz (Earth) + Dayuniis (Mind) + Yihinren (Form) + Yunugaz (Wind) |
| Weakbow Draught | Freiwynn (Vision) + Dayuniis (Mind) + Ordaniis (Enhance) + Armaniis (Desire) |
...
infuser\_finished:
 ...
 https://the-betweenlands.fandom.com/wiki/File:InfuserFinished.ogg 

History
---------

* Release 3.3.10: Now plays an animation and sound when creating an invalid infusion.
* Release 3.3.5: Now fills up with rain water in the Betweenlands.
* Alpha 3.0.0: Functionality reintroduced.

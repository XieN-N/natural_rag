...
| Anadia Parts | | |
| --- | --- | --- |
| **Anadia Part** | **Tooltip** | **Anadia Trimming Trait** |
| **Anadia Bones** | Thin, but resilient. Used in: Amphibious Helmet/Chestplate/Leggings/Boots | Grazer head type |
| **Anadia Eye** | Made for aquatic sight. Used in: Amphibious Helmet | Thumphead head type |
| **Anadia Fins** | They glide through the water like wings through air. Used in: Amphibious Chestplate/Leggings/Boots | Fantail tail type |
| **Anadia Gills** | Fish don't hold their breath. Used in: Amphibious Helmet/Chestplate | Prowler head type |
| **Anadia Remains** | Used in: Silk Bundle, Steeping Pot | Any rotten type, or from recycling any type |
| **Anadia Scales** | Forms a protective layer. Used in: Amphibious Helmet/Chestplate/Leggings/Boots | Cliptail tail type |
| **Anadia Swim Bladder** | Keeps the fish from sinking... and floating. Used in: Amphibious Chestplate/Leggings | Longtail tail type |
...
| Result | Ingredients | Recipe |
| --- | --- | --- |
| Amphibious Fishing Spear | **Anadia Fins** (3) + Fishing Spear |  |
...
| Result | Ingredients | Recipe |
| --- | --- | --- |
| Fish Oil (1000 mB) | Silk Bundle (containing **Anadia Remains** (4)) + Clean Water (1000 mB) |  |

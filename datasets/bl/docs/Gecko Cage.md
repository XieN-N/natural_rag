...
| Armaniis (Desire) | The gecko seems very calm and looks at you with loving eyes | N/A |
| Azuwynn (Muscle) | You can see the gecko's muscles twitching uncontrollably | N/A |
| Byariis (Corruption) | The gecko is chewing furiously on its tail and looks around as if possessed | The Gecko turns dark brown and twists to chew on its tail. |
| Byrginaz (Water) | The gecko is drooling, sweating and peeing around its cage | N/A |
| Celawynn (Stomach) | You can hear the gecko's belly rumbling and it seems to burp a lot | N/A |
| Dayuniis (Mind) | The gecko is walking around like a drunkard and looks around in a schizophrenic manner | N/A |
| Fergalaz (Earth) | The gecko's scales seem to become rock hard, it can barely move | The Gecko turns a tannish colour. |
| Firnalaz (Fire) | The gecko's scales have a red glow and it breathes a hot breath | The Gecko turns red. |
| Freiwynn (Vision) | The gecko's eyes are pulsating | N/A |
| Geoliirgaz (Void) | The gecko has an empty look in its eyes and doesn't seem to respond to anything | The Gecko turns pale brown. |
| Ordaniis (Enhance) | The gecko's scales seem to be glowing slightly | N/A |
| Uduriis (Chaos) | The gecko runs around frantically in nonsensical patterns | N/A |
| Wodren (Soul) | The gecko's eyes flare up and for a moment it looked like it had self awareness... | N/A |
| Yeowynn (Health) | You've never seen a healthier gecko, it's bursting with energy | N/A |
| Yunugaz (Wind) | The gecko seems light, and its breath sounds like a hollow wind | N/A |
| Yihinren (Form) | The gecko's scales became puffy and its head looks... different | The Gecko turns green and changes shape. |

Fuel
------

The Gecko Cage can be used as fuel for the Sulfur Furnace or Dual Sulfur Furnace, smelting 1.5 items per cage block.
...
* Release 3.3.0:
  + Now spawns the caged Gecko when broken.
  + Added Advancements.

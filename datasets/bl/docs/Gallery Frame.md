...
gallery\_frame\_small  
gallery\_frame\_large  
gallery\_frame\_very\_large

**Gallery Frames** are decorative items, placeable as entities, that depict fan-made artwork for the Betweenlands mod. In a sense, they are the Betweenlands equivalent of vanilla Paintings.

There are three size variants of Gallery Frame: **Small** (1x1 block), **Large** (2x2 blocks), and **Very Large** (4x4 blocks).
...
* 2 Properties
  + 2.1 Placement
  + 2.2 Displaying Artwork
    - 2.2.1 Artwork Submission
    - 2.2.2 List of Current Submissions
* 3 History
...
| **Caverns of the Betweenlands** (Source) |  | Владимир | N/A |
| **Riftless Night** (Source) |  | Støne | Are they fireflies? Orbs? Or those mysterious glowing spheres that seem to disappear as you approach? Could be a fiery lotus out on the lake... Hm... |
| **Betweenlands Winter** (Source) |  | baguchan | N/A |
...
| **The Prime Wight's Wrong** (Source) |  | MontserratGamer | With the intention of using the power of the Nether as a weapon to protect the Betweenlands, the Prime Wight condemned them forever... |
| **Silt Crab** |  | themerchantofbenis | N/A |
| **Eccentric Ecology** |  | Sir Terravolt | N/A |
| **Little Nap** (Source) |  | Ambargem | Two friends sleeping together in a beautiful night |
| **Inauspicious Darkness** (Source) |  | Haselberry12 | N/A |
...
| **Aurora** |  | Templar\_BR | N/A |
| **The Tower** |  | Templar\_BR | N/A |
...
| **Cute** (Source) |  | Shivanyan | N/A |
| **The Wandering Sporeling** (Source) |  | CT\_Squared | N/A |
| **Birth of the Between** (Source) |  | Lylythii | N/A |
| **Blue Wit** |  | Mans | N/A |
| **Blue Capped Night** |  | Ron | N/A |
| **Challenging The Spirit** |  | Ron | N/A |
| **Pillar Of The Circle** |  | Ron | N/A |
| **The Swamplands Rift** |  | Ron | N/A |
| **Just a moment to realise** |  | Darkus\_Shadow | Wanderer on the mud |
| **Swamp Raid** |  | Darkus\_Shadow | Maybe it was not a good idea to go outside for a walk |
| **Harmonious Music** |  | Darkus\_Shadow | I would like to hear them more. |
| **The Rift and the Auroras** |  | Darkus\_Shadow | 3 adventurers observing the unknown |
...
| **The tower that reaches the sky** |  | Darkus\_Shadow | Explore until you get lost with friends, it can have its benefits. |
| **Angry Snails** |  | Darkus\_Shadow | Blood Snails can be dangerous if there are too many of them. |
| **Finding a Simulacrum** |  | Darkus\_Shadow | Candles in a dark cave will always mean there is a forgotten statue. |
| **The Matriarch** |  | Darkus\_Shadow | Getting to the top and facing the matriarch for the first time is an incredible experience. |
...
| **Fruits of the Marsh** (Source) |  | CT\_Squared | A Spirit Fruit, a Forbidden Fig, and White Pears - a still life. |
...
* Release 3.5.1: Pictures are now only loaded into memory when necessary.

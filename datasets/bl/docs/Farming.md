...
Various crops, and a Bottled Fog-filled Censer.
...
* 1 Process
  + 1.1 Speeding up Growth
* 2 Types of Plants
  + 2.1 Crops
  + 2.2 Basic Plants
  + 2.3 Sludgeon Plants
  + 2.4 Plants that Don't Require Compost
* 3 Hazards
  + 3.1 Rain
  + 3.2 Decay
* 4 History
...
Shovels make holes, which can then be filled with compost.
...
A Compost Bin, filled with plants.
...
Weeping Blues, growing from the one on the Compost-filled block.

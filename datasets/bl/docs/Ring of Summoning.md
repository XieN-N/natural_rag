...
The **Ring of Summoning** is a powerful item that summons allies from the depths. It is the reward for defeating the Dreadful Peat Mummy.
...
* Release 3.3.8: Now only targets hostile mobs.
* Release 3.3.0: Added Advancement.
* Alpha 3.0.0: Can now be obtained again.
* Beta 2.0.0: Improved functionality, but made temporarily unobtainable.
* Beta 1.0.1: Now has a cooldown.

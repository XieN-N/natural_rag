...
* Swamplands biomes have a decent landmass and relatively thick groups of Weedwood, Rubber, and Nibbletwig Trees.
* Patchy Islands biomes have many good early sources of food as well as Weedwood and Hearthgrove Trees, but are also home to Leeches, Blood Snails, and Shamblers.
* Marsh biomes contain plentiful loot in the Marsh Ruins, but are also home to Shallowbreaths, deadly clouds of gas, and Peat Mummies, rare but powerful monsters that rise out of Peat or Mud to hunt down players. On top of this, there are plenty of Mud patches and Swamp Water pools to slow the player.
* Coarse Islands, Raised Isles, and Deep Waters biomes contain Cragrock, which is essential for many crafting recipes, as well as Swamp Kelp as a food source. Deep Waters biomes also contain a variety of sea life and are a prime location to hunt or fish for Anadia. The Raised Islands in Raised Isles biomes provide a great vantage point to survey the land below, but be on the lookout for Chiromaw Matriarchs and their Nests, which are especially dangerous for an unprepared player.
* Sludge Plains biomes are covered in Mud and Sludgy Dirt, which greatly hinders movement. Peat Mummies, Tar Beasts, and Sludges are found here. Although there are often loot-filled Sludge Plains Ruins, this biome is extremely dangerous and avoiding it until you are prepared is highly recommended.

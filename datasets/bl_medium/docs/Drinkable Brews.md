...
drinkable\_brew *(data values 0-10)*
...
| **Nettle Soup** | Clean Water (1000 mB) +  Black Hat Mushroom (item) +  Flathead Mushroom (item) +  Nettle or  Flowered Nettle | Restores 2 hunger and 0.6 saturation. Can be eaten even if the player's hunger bar is already full. Is not affected by Food Sickness. |
| **Nettle Tea** | Clean Water (1000 mB) +  Nettle Leaf (3) | Restores 0.2 saturation. |
| **Pheromone Extract** | Clean Water (1000 mB) +  Clutch of Pheromone Thoraxes (4) | Causes Infestations to act passive towards the player for 2 minutes. The infestation overlay from being near one can still damage the player. |
| **Swamp Broth** | Clean Water (1000 mB) +  Raw Snail Flesh +  Ball of Sap +  Flathead Mushroom (item) | Restores 0.2 saturation. Grants the  Elixir of Ripening II effect for 20 seconds, which restores the player's decay bar over time. |
| **Sturdy Stock** | Clean Water (1000 mB) +  Raw Snail Flesh +  Barnacle Flesh +  Raw Anadia Meat +  Ground Arrow Arum | Restores 2 saturation. |
| **Pear Cordial** | Clean Water (1000 mB) +  White Pear +  Sludge Ball +  Sap Spit | Restores 0.2 saturation. Reduces fall damage that the player takes down to 12.5% of the original damage for 20 seconds. |
| **Shaman's Brew** | Clean Water (1000 mB) +  Wisp +  Bulb-Capped Mushrooms +  Ground Mire Coral | Restores 0.2 saturation. Grants the  Hunter's Sense Brew II effect, which allows the player to see "scent trails" of mobs, and the vanilla  Night Vision II effect for 20 seconds each. |
| **Lake Broth** | Clean Water (1000 mB) +  Crab Claw +  Barnacle Flesh +  Raw Anadia Meat +  Ground Algae | Restores 0.2 saturation. Grants the vanilla  Water Breathing II effect for 20 seconds. |
| **Shell Stock** | Clean Water (1000 mB) +  Raw Snail Flesh +  Ground Crimson Snail Shell +  Ground Ochre Snail Shell | Restores 0.2 saturation. Prevents the player from getting stuck in Mud or Sludge blocks for 20 seconds. |
| **Frog Leg Extract** | Clean Water (1000 mB) +  Raw Frog's Leg (4) | Restores 0.2 saturation. Grants the vanilla  Jump Boost II effect for 20 seconds. |
| **Witch Tea** | Clean Water (1000 mB) +  Tiny Sludge Worm (item) +  Chiromaw Wing +  Raw Frog's Leg +  Yellow Dotted Fungus | Restores 0.2 saturation. Resets the Food Sickness values on all foods to 0 (unlike with Chiromaw Wings, this does *not* cause the tea to become sickening to drink itself). Spawns 4 Tiny Sludge Worm Helpers from the player, which will attack nearby aggressive and neutral mobs. |

...
* Fixed Black Hat Mushroom (item) giving poison instead of hunger
...
* Added Pitstone and Cragrock Walls, Stairs and Slabs
...
* Dark Druids no longer drop Swamp Talisman Pieces that the player already has in the inventory
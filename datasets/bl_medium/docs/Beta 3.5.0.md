...
**Beta 3.5.0** was a major update to the Betweenlands for Minecraft 1.12.2 that was released on November 4, 2019. It was known as the **Mud 'n Sludge, Embers 'n Censers** update as it added the Sludgeon and its many layers and encounters, as well as a variety of blocks and mobs related to the new structure, Emberlings, Censers, new items and equipment, Gallery Frames to showcase fan art, massive loot table changes, and several other changes and bug fixes. It is the largest update to the mod to date.
...
* Added new Sludgeon mobs; Tiny, Small and Large Sludge Worms, Shamblers, Crypt Crawlers, Ash Sprites, Emberling Shamans, Lampreys, Living Roots, and Barrishees
* Added some other Sludgeon encounters; Worm Holes, Sludge Jet Turrets, Splodeshrooms, and Moving Walls
* Added new Advancements
* Added a new music track by Rovycre for the Pit encounter
...
* Aspectrus Plants are now grown by planting them in the range of a Censer applying the corresponding Aspect fog, instead of applying the Aspect Vial directly
